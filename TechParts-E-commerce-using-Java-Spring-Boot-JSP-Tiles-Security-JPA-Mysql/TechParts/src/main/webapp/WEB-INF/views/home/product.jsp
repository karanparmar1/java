...
<body>
	...
	<div class="container padding-bottom-3x">
		<div class="row">
					...
					<div class="product-carousel owl-carousel gallery-wrapper">
						<div class="gallery-item" data-hash="one">
							<a href="img/shop/single/01.jpg" data-size="1000x667">
								<img src="${path}/resources/user/img/shop/single/01.jpg" alt="Product">
							</a>
						</div>
						<div class="gallery-item" data-hash="two">
							<a href="img/shop/single/02.jpg" data-size="1000x667">
								<img src="${path}/resources/user/img/shop/single/02.jpg" alt="Product">
							</a>
						</div>
						<div class="gallery-item" data-hash="three">
							<a href="img/shop/single/03.jpg" data-size="1000x667">
								<img src="${path}/resources/user/img/shop/single/03.jpg" alt="Product">
							</a>
						</div>
						<div class="gallery-item" data-hash="four">
							<a href="img/shop/single/04.jpg" data-size="1000x667">
								<img src="${path}/resources/user/img/shop/single/04.jpg" alt="Product">
							</a>
						</div>
						<div class="gallery-item" data-hash="five">
							<a href="img/shop/single/05.jpg" data-size="1000x667">
								<img src="${path}/resources/user/img/shop/single/05.jpg" alt="Product">
							</a>
						</div>
					</div>
					<ul class="product-thumbnails">
						<li class="active"><a href="#one">
								<img src="${path}/resources/user/img/shop/single/th01.jpg" alt="Product">
							</a></li>
						<li><a href="#two">
								<img src="${path}/resources/user/img/shop/single/th02.jpg" alt="Product">
							</a></li>
						<li><a href="#three">
								<img src="${path}/resources/user/img/shop/single/th03.jpg" alt="Product">
							</a></li>
						<li><a href="#four">
								<img src="${path}/resources/user/img/shop/single/th04.jpg" alt="Product">
							</a></li>
						<li><a href="#five">
								<img src="${path}/resources/user/img/shop/single/th05.jpg" alt="Product">
							</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="col-md-6">
				...
				<h2 class="mb-3">GoPro Karma Camera Drone</h2>
				<span class="h3 d-block">
					<del class="text-muted">$958.00</del>
					&nbsp; $899.00
				</span>
				<p class="text-muted">
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta voluptatibus quos ea dolore rem, molestias
					laudantium et explicabo...
				...
				<div class="row align-items-end pb-4">
					...
					<div class="col-sm-8">
						...
						<button class="btn btn-primary btn-block m-0" data-toast data-toast-type="success" data-toast-position="topRight"
				...
				<div class="pt-1 mb-4">
					<span class="text-medium">SKU:</span>
					#21457832
				</div>
				<hr class="mb-2">
				<div class="d-flex flex-wrap justify-content-between">
					<div class="mt-2 mb-2">
						<button class="btn btn-outline-secondary btn-sm btn-wishlist">
							<i class="icon-heart"></i>&nbsp;To Wishlist
						</button>
						<button class="btn btn-outline-secondary btn-sm btn-compare">
							<i class="icon-repeat"></i>&nbsp;Compare
						</button>
					</div>
					<div class="mt-2 mb-2">
						<span class="text-muted">Share:&nbsp;&nbsp;</span>
						<div class="d-inline-block">
							<a class="social-button shape-rounded sb-facebook" href="#" data-toggle="tooltip" data-placement="top"
								title="Facebook">
								<i class="socicon-facebook"></i>
							</a>
							<a class="social-button shape-rounded sb-twitter" href="#" data-toggle="tooltip" data-placement="top"
								title="Twitter">
								<i class="socicon-twitter"></i>
							</a>
							<a class="social-button shape-rounded sb-instagram" href="#" data-toggle="tooltip" data-placement="top"
								title="Instagram">
								<i class="socicon-instagram"></i>
							</a>
							<a class="social-button shape-rounded sb-google-plus" href="#" data-toggle="tooltip" data-placement="top"
								title="Google +">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
						...
						ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat.</p>
			...
			<div class="col-md-4 mb-4">
				<div class="card border-default">
					<div class="card-body">
						...
						<div class="pt-2">
							<a class="btn btn-warning btn-block" href="#" data-toggle="modal" data-target="#leaveReview">Leave a Review</a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-md-8">
				...
				<div class="comment">
					<div class="comment-author-ava">
						<img src="img/reviews/02.jpg" alt="Comment author">
					</div>
				...
				<div class="comment">
					<div class="comment-author-ava">
						<img src="img/reviews/03.jpg" alt="Comment author">
					</div>
					<div class="comment-body">
						<div class="comment-header d-flex flex-wrap justify-content-between">
				...
				<!-- View All Button-->
				<a class="btn btn-secondary btn-block" href="#">View All Reviews</a>
			</div>
		</div>
	</div>
	<div class="container padding-bottom-3x mb-1">
		...
		<div class="owl-carousel"
			...
			<div class="product-card">
				<a class="product-thumb" href="shop-single.html">
					<img src="${path}/resources/user/img/shop/products/11.jpg" alt="Product">
				</a>
				<div class="product-card-body">
					<div class="product-category">
						<a href="#">Headphones</a>
			...
			<div class="product-card">
				...
				<a class="product-thumb" href="shop-single.html">
					<img src="${path}/resources/user/img/shop/products/06.jpg" alt="Product">
				</a>
				<div class="product-card-body">
					<div class="product-category">
					...
					<h3 class="product-title">
						<a href="shop-single.html">Xbox One S White</a>
					</h3>
			...
			<div class="product-card">
				<a class="product-thumb" href="shop-single.html">
					<img src="${path}/resources/user/img/shop/products/07.jpg" alt="Product">
				</a>
				<div class="product-card-body">
					<div class="product-category">
			...
			<div class="product-card">
				...
				<a class="product-thumb" href="shop-single.html">
					<img src="${path}/resources/user/img/shop/products/12.jpg" alt="Product">
				</a>
				<div class="product-card-body">
					<div class="product-category">
				...
				<div class="product-button-group">
					...
					<a class="product-button" href="shop-single.html">
			...
			<div class="product-card">
				...
				<a class="product-thumb" href="shop-single.html">
					<img src="${path}/resources/user/img/shop/products/10.jpg" alt="Product">
				</a>
				<div class="product-card-body">
					<div class="product-category">
					...
					<h3 class="product-title">
						<a href="shop-single.html">HP LaserJet Pro Printer</a>
					</h3>
			...
			<div class="product-card">
				<div class="product-badge bg-danger">Sale</div>
				<a class="product-thumb" href="shop-single.html">
					<img src="${path}/resources/user/img/shop/products/09.jpg" alt="Product">
				</a>
				<div class="product-card-body">
					<div class="product-category">
						<a href="#">Action cameras</a>
