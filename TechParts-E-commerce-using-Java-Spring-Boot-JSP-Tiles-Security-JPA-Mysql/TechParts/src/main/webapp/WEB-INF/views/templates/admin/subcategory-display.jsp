			...
			<div class="main-bar row">
				<div class="col-lg-6 col-sm-4">
					<h4 class="nav_top_align">
						<i class="fa fa-list-ul"></i> Sub Categories  of ${category.name} Category
					</h4>
				</div>
				<div class="col-lg-6 col-sm-8 col-xs-12">
					<ol class="breadcrumb float-xs-right  nav_breadcrumb_top_align">
						<li class="breadcrumb-item"><a href="${path}/admin/dashboard">
							...
							<li class="breadcrumb-item"><a href="${path}/admin/category/">
								<i class="fa fa-home" data-pack="default" data-tags=""></i> ${category.name}
							</a></li>
						<li class="active breadcrumb-item">SubCategories</li>
					</ol>
				</div>
			</div>
		</header>
				...
				<div class="card">
					<c:if test="${message!=null}">
						<div class="row">
							...
							<div class="col-xs-10  my-1 text-sm-center alert alert-info alert-dismissable">
					...
					<div class="card-block m-t-0" id="user_body">
						<div class="table-toolbar">
							<div class="btn-group">
								<a href="${path}/admin/category/${category.id}/addsubcategory" id="editable_table_new" class=" btn btn-default">
						...
						<div>
							...
							<div>
								<table class="table table-striped table-bordered  table-hover dataTable no-footer text-sm-center myTableData"
									...
									<tbody>
										<c:forEach var="cat" items="${category.categories}">
											<tr id="row${cat.id}" role="row" class="even">
												...
												<td>
													<a class="edit" data-toggle="tooltip" data-placement="top" title="Edit"
														href="${path}/admin/category/${category.id}/subcategory/${cat.id}/edit"> 
														<i class="fa fa-pencil text-warning"></i>
													</a>&nbsp;&nbsp; &nbsp; &nbsp;
													<a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top"
														title="Delete" href="<%-- ${path}/admin/category/delete/${cat.id} --%>javascript:void(0)"
														onClick="deleteRow('category',${cat.id})">
														<i class="fa fa-trash text-danger"></i>
													</a> &nbsp;&nbsp; &nbsp; &nbsp;
													<a data-toggle="tooltip" data-placement="top" title="SubCategories"
														href="${path}/admin/category/${cat.id}/subcategories">
