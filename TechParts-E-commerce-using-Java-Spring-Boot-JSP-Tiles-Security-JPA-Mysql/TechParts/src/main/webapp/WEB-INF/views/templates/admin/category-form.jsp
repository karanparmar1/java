		...
		<div class="main-bar row">
			<div class="col-lg-6">
				<h4 class="nav_top_align skin_txt">
					<i class="fa fa-user"></i> ${reqType} Category
				</h4>
			</div>
			<div class="col-lg-6">
				<ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
					...
					<li class="breadcrumb-item"><a href="${path}/admin/category/">Category</a></li>
		...
		<div class="inner bg-container">
			<div class="card">
				...
				<div class="card-block m-t-15">
					<div>
						<h4> ${reqType } Category</h4>
					</div>
					<s:form cssClass="form-horizontal login_validator" method="post" modelAttribute="category" id="tryitForm" action="${path}/admin/category/add">
						<div class="row">
							<div class="col-xs-12">
									<s:hidden path="id" />
