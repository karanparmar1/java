...
<c:set var="path" value="${pageContext.request.contextPath}"></c:set>
	...
	<footer class="site-footer"
		style="background-image: url(${path}/resources/user/img/footer-bg.png);">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<!-- Categories-->
				...
				<div class="col-lg-6">
					...
					<c:choose>
						<c:when test="${currentUser!=null}">
							<div class="col-sm-3">
								<a href="javascript:void(0);" onclick="document.forms['logoutForm'].submit()"  class="btn btn-primary btn-block mt-0"> 
									LogOut 
								</a>
							</div>
						</c:when>
						<c:otherwise>
							<div class="col-sm-3">
								<a href="${path}/resources/user/login" class="btn btn-primary btn-block mt-0"> LogIn </a>
							</div>
						</c:otherwise>
					</c:choose>
				</div>
